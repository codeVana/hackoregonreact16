...
const ReMeMeder = function() {
  ...
  return <Email title="Hello from ReMeMeder" headCSS={css}> {/* then we inject the css here, to the left, in a prop called headCSS */}
    ...
    <Item>
        ...
        <Item>
          <Span color="gray" lineHeight={20}>Generated by <A href="https://github.com/codeVana/hackoregonreact16/tree/master/hackoregon-meteor-react-rememeder">ReMEMEder: A Meteor+React App</A></Span>
    ...
    <Item>
      <Box cellSpacing={20} width="100%" style={{ borderTop: '3px solid black' }}>
        <Item>
          ...
          <Image data-mc-bar="bar" data-mc-baz="baz" alt="react" src="https://facebook.github.io/react/img/logo.svg" width={100} height={100} />
        </Item>
      </Box>
    </Item>
    </Email>;
